...
/////////////////////////////////////////////////////////////////
	public List<MemberVO> selectAllMember() { //전체 회원 정보 조회 메서드
...
/////////////////////////////////////////////////////////////////
	public List<Member_logVO> selectAllMemberLog() { //전체 회원 정보 로그 조회 메서드
...
/////////////////////////////////////////////////////////////////
	public void insertMember(MemberVO mVo) {//회원가입 메서드
...
/////////////////////////////////////////////////////////////////
	public List<BoardVO> selectBoardList(String type) {//게시판 조회하기
...
/////////////////////////////////////////////////////////////////
	public BoardVO selectBoardList_info_all(int idx) {//게시물 상세조회하기
...
/////////////////////////////////////////////////////////////////
	public int selectBoardList_info_nextBoard_idx(int idx, String type) {//다음 게시물 idx 가져오는 메서드
...
/////////////////////////////////////////////////////////////////
	public int selectBoardList_info_beforeBoard_idx(int idx, String type) {//이전 게시물 idx 가져오는 메서드
...
/////////////////////////////////////////////////////////////////
	public int[] firstAndEnd_idx(String type) { //게시물 처음과 끝 idx 가져오기
...
/////////////////////////////////////////////////////////////////
	public boolean updateBoard(BoardVO bVo) { // 게시물 수정 메서드
		...
		Connection conn = null;
		PreparedStatement psmt = null;
		System.out.println("컨텐츠 값"+bVo.getBoard_content());
		try {
			conn = DBManager.getConnection();
			psmt = conn.prepareStatement(sql);
...
/////////////////////////////////////////////////////////////////
	public void deleteBoardData(String idx, String cul) { // 특정게시물의 특정컬럼값 삭제
...
/////////////////////////////////////////////////////////////////
	public int getSelectNumBoard(String type) {	// 특정 type 게시물의 전체 게시물 수 구함
		int cntAll = 0;
...
/////////////////////////////////////////////////////////////////
	public int getSelectNumBoard_search(String type, String searchText) { // 특정 type 게시물의, 검색결과에 해당되는 수를 구함
		int cntAll = 0;
...
/////////////////////////////////////////////////////////////////
	public List<BoardVO> selectTargetBoard_img(int section, int pageNum, String type) { //이미지보드 9개씩 불러오기
		List<BoardVO> boardList = new ArrayList<>();
...
/////////////////////////////////////////////////////////////////
	public List<BoardVO> selectTargetBoard(int section, int pageNum, String type) { //일반 게시물 10개씩 불러오기
		List<BoardVO> boardList = new ArrayList<>();
...
/////////////////////////////////////////////////////////////////	
	public List<BoardVO> selectSearchBoard(int section, int pageNum, String type, String searchText) { //검색결과 게시물 리스트검색
		List<BoardVO> boardList = new ArrayList<>();
...
/////////////////////////////////////////////////////////////////
	public MemberVO selectMember(String userId) { //해당 회원정보 불러오기
...
/////////////////////////////////////////////////////////////////
	public int confirmID(String member_id) { //회원ID중복 검사
		int result = -1;
...
/////////////////////////////////////////////////////////////////	
	public String transeCode(String member_pwd) { //비밀번호 암호화
		try {
...
/////////////////////////////////////////////////////////////////
	public void select_countUp(int idx, int count) { // 조회수 상승 메서드
		count = count+1;
