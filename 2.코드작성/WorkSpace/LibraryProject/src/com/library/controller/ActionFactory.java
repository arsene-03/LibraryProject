...
import com.library.controller.action.Contact_action;
import com.library.controller.action.CustomBoard_action;
...
import com.library.controller.action.ReviewDelete_action;
import com.library.controller.action.ReviewInsert_action;
import com.library.controller.action.UpdateBoard_form_action;
import com.library.controller.action.admin_member_log_action;
import com.library.controller.action.login_profile_aciton;
...
import com.library.controller.action.SponsorInput_action;
import com.library.controller.action.Sponsor_action;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		}else if(command.equals("customBoard_action")) {
			action = new CustomBoard_action();
		}else if(command.equals("sponsor_action")) {
			action = new Sponsor_action();
		}else if(command.equals("sponsorInput_action")) {
			action = new SponsorInput_action();
		}else if(command.equals("contact_action")) {
			action = new Contact_action();
		}else if(command.equals("reviewInsert")) {
			action = new ReviewInsert_action();
		}else if(command.equals("reviewDelete")) {
			action = new ReviewDelete_action();
		}else if(command.equals("login_profile_action")) {
			action = new login_profile_aciton();
		}else if(command.equals("admin_member_log_action")) {
			action = new admin_member_log_action();
		}
		return action;
	}
}
