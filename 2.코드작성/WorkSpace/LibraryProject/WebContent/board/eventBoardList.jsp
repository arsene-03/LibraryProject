...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/css/frame.css?ver=38">
</head>
<body id="firstPage">
			...
			<article class="frame">
				<div class="frame_con" >
					<div class="frame_inner">
						<div class="boardPageTitle">이벤트</div>
						...
						<div class="searchBox">
							<form action="LS" method="POST">
								...
								<input type="text" name="searchText" class="searchText" placeholder="이벤트를 검색해 보세요">
						...
						<table class="eventTable">
							...
							<tr>
								...
								<!-- 게시판 제목/내용 부분 -->
								<td>
									<div class="eventBoardTitle"><%=board.getBoard_title()%></div>
									<div class="eventBoardContent"><%=content%></div>
									<div class="eventBoardCounter">
