    		...
    		<legend>필수정보</legend>
    			<table class="signUpTable">
    				<tr>
    					...
    					<td><input type="text" name="member_id" id="member_id" class="inputText_1"></td>
    					<td>
    				...
    				<tr>
    					...
    					<td colspan="1">
						<c:if test="${secAdCode == 'admin'}">
							<label for="common">일반회원</label>
    						<input type="radio" name="member_type" id="common" value="common" disabled >
    						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						<label for="admin">관리자</label>
    						<input type="radio" name="member_type" id="admin" value="admin" disabled checked>
						</c:if>
						<c:if test="${secAdCode == null}">
    						<label for="common">일반회원</label>
    						<input type="radio" name="member_type" id="common" value="common" disabled checked>
    						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						<label for="admin">관리자</label>
    						<input type="radio" name="member_type" id="admin" value="admin" disabled>
    					</c:if>
    					</td>
    				</tr>
    			</table>
